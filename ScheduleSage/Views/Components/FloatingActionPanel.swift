  ...
  var body: some View {
    ...
    .background(
      ZStack {
        ...
        if #available(macOS 12.0, *) {
          ...
          RoundedRectangle(cornerRadius: 20)
            .fill(
              colorScheme == .dark ? DesignSystem.Colors.cardBackground.opacity(0.85) : Color.white.opacity(0.85)
            )
        }
        ...
        RoundedRectangle(cornerRadius: 20)
          .stroke(
            colorScheme == .dark ? DesignSystem.Colors.primary.opacity(0.2) : DesignSystem.Colors.primary.opacity(0.1),
            lineWidth: 0.5
          )
      }
    )
    .shadow(
      color: colorScheme == .dark
        ? DesignSystem.Colors.primary.opacity(isHovered ? 0.2 : 0.15) : Color.black.opacity(isHovered ? 0.12 : 0.08),
    ...
    Button(action: handleButtonTap) {
      VStack(spacing: 6) {  // 减少垂直间距
        ...
        Text(title)
          ...
          .foregroundColor(
            isHovered ? DesignSystem.Colors.primary : DesignSystem.Colors.primaryText
          )
